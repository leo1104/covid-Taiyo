...
function Contact() {
  ...
  return (
    <div className=" h-full w-full relative ">
      <div className="flex flex-wrap justify-start items-center max-h-screen gap-10">
        {contactArray.map((contact: any) => {
          return (
            <div
              key={contact.id}
              className="flex justify-between items-center h-18 p-4 w-fit rounded-lg shadow-lg shadow-indigo-500/50"
            >
              <div
              ...
              >
                ...
                <div className="flex flex-col justify-center items-start ml-4">
                  <span className="text-lg font-bold text-gray-700 text-fix w-fit">
