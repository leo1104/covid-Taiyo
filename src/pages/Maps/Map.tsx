...
import FetchCountries from "../../Store/API/FetchCountries.tsx";
      ...
      {data &&
        data?.map((posi: any, index: number) => (
          ...
          >
            <Popup>
              <h1>{posi.country}</h1>
              <p className="text-blue-500">Active: {posi.active}</p>
              <p className="text-green-500">Recovered: {posi.recovered}</p>
              <p className="text-red-500">Deaths: {posi.deaths}</p>
            </Popup>
