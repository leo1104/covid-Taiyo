...
function Dashboard() {
  ...
  return (
    <>
      <div className="flex justify-center gap-4 items-center flex-wrap pt-8">
      ...
      <div className="w-95 h-1/2 gap-4 my-3 shadow-[0_3px_10px_rgb(0,0,0,0.2)] rounded-xl">
        <Line
      ...
      <div className="grid h-2/5 md:grid-cols-2 w-95 gap-5 mt-5 ">
